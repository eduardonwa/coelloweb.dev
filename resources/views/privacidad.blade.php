<x-site-layout>
    <section class="container padding-block-10 padding-inline-5 flow">
        <h1 class="fs-700 uppercase">Aviso de privacidad</h1>
        <p class="fs-500">
        ...
        <h2 class="fs-700">Información recopilada</h2>
        <p class="fs-500">
        ...
        <h2 class="fs-700">Uso de la información recogida</h2>
        <p class="fs-500">
        ...
        <p class="fs-500">
            ...
            de su web. Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia.
            ...
            un mejor servicio de los sitios web, estás no dan acceso a información de su ordenador ni de usted, a menos de que
        ...
        <h2 class="fs-700">Enlaces a Terceros</h2>
        <p class="fs-500">
        ...
        <h2 class="fs-700">Control de su información personal</h2>
        <p class="fs-500">
            ...
            mi boletín o publicidad usted puede cancelarla en cualquier momento. Esta compañía no venderá, cederá ni
            distribuirá la información personal que es recopilada sin su consentimiento, salvo que sea requerido por un juez
